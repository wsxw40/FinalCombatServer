...
public class SysItemManageWindow extends mx.containers.VBox
{
	public function SysItemManageWindow() {}
	...
	[Bindable]
	public var showLog : mx.controls.Button;
	[Bindable]
	public var showPaymentView : mx.controls.Button;
	[Bindable]
	public var resetCached : mx.controls.Button;
	[Bindable]
	public var characterCb : mx.controls.ComboBox;
	[Bindable]
	...
	[Bindable]
	public var vdArea : mx.containers.VDividedBox;
	[Bindable]
...
include "D:/info_server/bj/WEB-INF/flex-src/window/SysItemManageWindow.mxml:8,623";
