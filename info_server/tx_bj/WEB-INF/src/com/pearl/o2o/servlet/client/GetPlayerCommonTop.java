...
//			}
	...
	private String generateRetStr(String key,Player player) throws Exception{
		...
		Integer mateRank=getService.getQW_MateRank(player.getId());
		String result = new StringBuilder().append(pref).append(valueStr).append(",").append(mateRank).append("},").toString();
		return result;	
	}
	/**
	 * 玩家加入真实排行榜记录
