...
//			}
			...
			return Converter.onlineAward(rv.getLeftSeconds(),rv.getCExp(),rv.getNextTime(), awards, rv.getErrormsg());
	...
	/**
	 * 发放不进行提示的奖励,2013,12,25 文档舍去发放原石需求
	 * @param playerId
	 * @throws Exception
	 */
	private QuietBounds createBoundsOnlineQuietly(int playerId,int level) throws Exception{
		//发放在线奖励
		return createService.createBoundsOnlineAward(playerId,level);
	}
}
