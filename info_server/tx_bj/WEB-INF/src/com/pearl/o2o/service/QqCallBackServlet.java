...
public class QqCallBackServlet extends BaseServerServlet {
	...
	public void service(ServletRequest request, ServletResponse response)
		...
		try {
			...
			boolean verifySig = MySnsSigCheck.verifySig(ConstantsQQ.METHOD_GET, url_path, params, ConstantsQQ.APPKEY+"&", sig);
			Quser quser = nosqlService.getOidToQuser(openid);
			Integer pid = quser.getId();
			System.out.println(verifySig+"   verifySig");
			if (verifySig) {//对上回调成功
				//===========发送start===========
				...
				MyOpenApiV3 myOpenApiV3 = new MyOpenApiV3(ConstantsQQ.APPID, ConstantsQQ.APPKEY);
				myOpenApiV3.setServerName(ConstantsQQ.SERVER_NAME);
				String resp = myOpenApiV3.api(ConstantsQQ.URL_CONFIRM_DELIVERY,	params, ConstantsQQ.PROTOCOL_HTTPS,	ConstantsQQ.METHOD_GET);
