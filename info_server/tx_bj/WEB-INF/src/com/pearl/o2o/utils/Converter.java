 ...
 * ,vR=#$sum[11]#, vip等级 */
	 ...
	 * @return
	 */
	public static String getQqBuyGoods(int ret, String url_params) {
		String value="";
		try{
			Context ctx = new Context();
			ctx.set("ret", ret);
			ctx.set("url_params", url_params);
			return sm.getEncodedBody("GetQqBuyGoods.st",  ctx);
		}catch(Exception e){
			log.warn("Error in getQqBuyGoods: ", e);
		}
		return value;
	}
}
