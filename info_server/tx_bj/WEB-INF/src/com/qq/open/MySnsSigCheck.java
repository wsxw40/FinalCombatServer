...
public class MySnsSigCheck 
{
	...
	public static String makeSource(String method, String url_path,
		...
		buffer.append(method.toUpperCase()).append("&")
				.append(encodeUrl(url_path)).append("&");
    ...
    * @return 签名所需源串
    */
	public static String my_makeSource(String method, String url_path,
			HashMap<String, String> params) throws OpensnsException {
		Object[] keys = params.keySet().toArray();
	...
	public static boolean verifySig(String method, String url_path,
		...
		// VvKwcaMqUNpKhx0XfCvOqPRiAnU=
		// VvKwcaMqUNpKhx0XfCvOqPRiAnU%3D
		sig_new = MySnsSigCheck.encodeValue(sig_new);
