 ...
 * 
 */
public class FckDispatcher {

	private static final Logger logger = LoggerFactory.getLogger(Dispatcher.class);
	private Connector connector;

 
	public FckDispatcher(final ServletContext servletContext) throws Exception {
	 ...
	 *             due to some reason
	 */
	private GetResponse getFoldersAndOrFiles(final Command command, final ResourceType type, final String currentFolder,
			final String constructedUrl) throws InvalidCurrentFolderException, ReadException {
		...
		// check parameters
			...
			try {
				...
				// Secure image check (can't be done if QuickUpload)
					...
					String newFileName = connector.fileUpload(type, context.getCurrentFolderStr(), sanitizedFileName,
