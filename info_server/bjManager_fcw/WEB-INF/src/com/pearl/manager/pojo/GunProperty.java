...
//	public final static int GREEND 	= 1;
...
//	public final static int GOLD 	= 6;
	...
	public static class Property implements Serializable{
		...
		private int time;
		private int color;
		private String basePropertyStr;
		...
		public String getBasePropertyStr() {
			return "";
//			CommonUtil.getPropertyStr(this.index,this.value,this.value2,this.time);
		}
		public void setBasePropertyStr(String basePropertyStr) {
			this.basePropertyStr = basePropertyStr;
		}
		public int getColor() {
			return color;
		}
