package utils
{
	...
	public class ColumnFactory
	{
		public static function getLevelColumns(hiLight:Boolean=false):Array{
			...
			var id:MyDataGridColumn=new MyDataGridColumn("id","地图ID",hiLight,50);
			id.editable=false;
			columns.push(id);
			columns.push(new MyDataGridColumn("type","类型",hiLight,40));
			columns.push(new MyDataGridColumn("name","资源名",hiLight,100));
			columns.push(new MyDataGridColumn("displayName","地图名称",hiLight,100));
...
//			columns.push(new MyDataGridColumn("zombieInfo","zombieInfo",hiLight,250));
			...
			columns.push(new MyDataGridColumn("description","description",hiLight,50));
		...
		public static function getLevelColumnsSimple(hiLight:Boolean=false):Array{
			...
			columns.push(new MyDataGridColumn("displayName","displayName",hiLight,100));
		...
		public static function getSysItemName2(hiLight:Boolean=false):Array{
			...
			columns.push(ck);
			var id:MyDataGridColumn=new MyDataGridColumn("id","系统物品ID",hiLight,80);
			id.editable=false;
			columns.push(id);
			columns.push(new MyDataGridColumn("displayName","名称",hiLight,100));
			columns.push(new MyDataGridColumn("name","资源名",hiLight,100));
			return columns;
		}
		public static function getAchievement(hiLight:Boolean=false):Array{
			...
			ck.itemRenderer=new ClassFactory(CheckBox);
			columns.push(ck);
			var id:MyDataGridColumn=new MyDataGridColumn("id","成就ID",hiLight,50);
			id.editable=false;
			columns.push(id);
			columns.push(new MyDataGridColumn("action","动作类型",hiLight,80));
			columns.push(new MyDataGridColumn("description","描述",hiLight,50));
			return columns;
		}
		...
		public static function getCharacterColumns(hiLight:Boolean=false):Array{
				var columns:Array = new Array();
				var id:MyDataGridColumn=new MyDataGridColumn("id","角色ID",hiLight,100);
				id.editable=false;
				columns.push(id);
				columns.push(new MyDataGridColumn("name","角色名",hiLight,100));
		...
		public static function getBioCharacterColumns(hiLight:Boolean=false):Array{
				...
				id.editable=false;
				columns.push(id);
				columns.push(new MyDataGridColumn("cid","角色ID",hiLight,50));
				columns.push(new MyDataGridColumn("sid","道具ID",hiLight,50));
				columns.push(new MyDataGridColumn("type","类型",hiLight,40));
				columns.push(new MyDataGridColumn("weapons","武器背包",hiLight,100));
				columns.push(new MyDataGridColumn("costumes","服装背包",hiLight,70));
				columns.push(new MyDataGridColumn("name","角色名",hiLight,120));
		...
		public static function getPlayerColumns(hiLight:Boolean=false):Array{
			var columns:Array = new Array();
			var id:MyDataGridColumn=new MyDataGridColumn("id","玩家ID",hiLight,100);
			id.editable=false;
			columns.push(id);
			var userId:MyDataGridColumn=new MyDataGridColumn("userName","用户名",hiLight,100);
		...
		public static function getPlayerColumnsAll(hiLight:Boolean=false):Array{
			...
			columns.push(new MyDataGridColumn("GPoint","C币",hiLight,200));
			columns.push(new MyDataGridColumn("GScore","积分",hiLight,200));
			columns.push(new MyDataGridColumn("credit","雷点",hiLight,200));
			columns.push(new MyDataGridColumn("voucher","抵用券",hiLight,200));
			return columns;
		}
		public static function getPlayerColumns1(hiLight:Boolean=false):Array{
			...
			columns.push(new MyDataGridColumn("rank","等级",hiLight,200));
			return columns;
		}
        ...
        public static function getColumnCommon():Array{
			var columns:Array = new Array();
			var id:MyDataGridColumn=new MyDataGridColumn("id","系统物品ID",false,80);
			id.editable=false;
			columns.push(id);
			columns.push(new MyDataGridColumn("displayName","名称",false,150));
			columns.push(new MyDataGridColumn("name","资源名",false,100));
			var isDeleted:MyDataGridColumn=new MyDataGridColumn("isDeleted","是否下架",false,80);
			isDeleted.itemRenderer=new ClassFactory(CheckBoxRenderer);
			isDeleted.editable=false;
			columns.push(isDeleted);
			columns.push(new MyDataGridColumn("WFixPrice","维修价格",false,100));
			var isVip:MyDataGridColumn=new MyDataGridColumn("isVip","是否VIP专属",false,100);
			isVip.itemRenderer=new ClassFactory(CheckBoxIsVipRenderer);
			isVip.editable=false;
			columns.push(isVip);
			var isWeb:MyDataGridColumn=new MyDataGridColumn("isWeb","是否网吧专属",false,100);
			isWeb.itemRenderer=new ClassFactory(CheckBoxIsWebRenderer);
			isWeb.editable=false;
			columns.push(isWeb);
			var isNew:MyDataGridColumn=new MyDataGridColumn("isNew","是否新品",false,80);
			isNew.itemRenderer=new ClassFactory(CheckBoxIsNewRenderer);
			isNew.editable=false;
			columns.push(isNew);
			var isHot:MyDataGridColumn=new MyDataGridColumn("isHot","取消赠送",false,80);
			isHot.itemRenderer=new ClassFactory(CheckBoxIsHotRenderer);
			isHot.editable=false;
			columns.push(isHot);
			var isPopular:MyDataGridColumn=new MyDataGridColumn("isPopular","是否热卖",false,80);
			isPopular.itemRenderer=new ClassFactory(CheckBoxIsPopularRenderer);
			isPopular.editable=false;
			columns.push(isPopular);
			var isExchange:MyDataGridColumn=new MyDataGridColumn("isExchange","能否兑换",false,80);
			isExchange.itemRenderer=new ClassFactory(CheckBoxIsExchangeRenderer);
			isExchange.editable=false;
			columns.push(isExchange);
			columns.push(new MyDataGridColumn("itemIndex","序列号",false,50));
			columns.push(new MyDataGridColumn("rareLevel","稀有率",false,50));
			columns.push(new MyDataGridColumn("evaluateRmb","价值评估",false,70));
		...
		public static function getColumnCommon2():Array{
			...
			id.editable=false;
			columns.push(id);
			columns.push(new MyDataGridColumn("displayName","名称",false,200));
			columns.push(new MyDataGridColumn("name","资源名",false,150));
			var isDeleted:MyDataGridColumn=new MyDataGridColumn("isDeleted","是否下架",false,150);
			isDeleted.itemRenderer=new ClassFactory(CheckBoxRenderer);
			isDeleted.editable=false;
			columns.push(isDeleted);
			columns.push(new MyDataGridColumn("WFixPrice","维修价格",false,100));
			var isVip:MyDataGridColumn=new MyDataGridColumn("isVip","是否VIP专属",false,150);
			isVip.itemRenderer=new ClassFactory(CheckBoxIsVipRenderer);
			isVip.editable=false;
			columns.push(isVip);
			var isWeb:MyDataGridColumn=new MyDataGridColumn("isWeb","是否网吧专属",false,100);
			...
			isWeb.editable=false;
			columns.push(isWeb);
			var isNew:MyDataGridColumn=new MyDataGridColumn("isNew","是否新品",false,150);
			isNew.itemRenderer=new ClassFactory(CheckBoxIsNewRenderer);
			isNew.editable=false;
			columns.push(isNew);
			var isHot:MyDataGridColumn=new MyDataGridColumn("isHot","取消赠送",false,150);
			isHot.itemRenderer=new ClassFactory(CheckBoxIsHotRenderer);
			isHot.editable=false;
			columns.push(isHot);
			return columns;
		...
		public static function getActivityColumn(isHiLight:Boolean):Array{
			...
			id.editable=false;
			columns.push(id);
			var isDeleted:MyDataGridColumn=new MyDataGridColumn("theSwitch","开关",false,50);
			isDeleted.itemRenderer=new ClassFactory(CheckBoxRenderer);
			isDeleted.editable=false;
			columns.push(isDeleted);
			columns.push(new MyDataGridColumn("value","参数1",false,50));
			columns.push(new MyDataGridColumn("targetNum","参数2",false,50));
			columns.push(new MyDataGridColumn("startTimeStr","开始时间",false,50));
			columns.push(new MyDataGridColumn("endTimeStr","结束时间",false,50));
			return columns;
		}
		...
		public static function getLogColumnCommon(isHiLight:Boolean):Array{
			...
			columns.push(new MyDataGridColumn("rareLevel","稀有率",false,100));
			var dg:MyDataGridColumn=new MyDataGridColumn("logTime","LogTime",false,150);
        ...
        public static function getColumnClothes(isHiLight:Boolean):Array{
			...
			var isAsset:MyDataGridColumn=new MyDataGridColumn("isAsset","取消续费",false,80);
			...
			columns.push(new MyDataGridColumn("isStrengthen","是否可强化",isHiLight,80,Constants.style_color,Constants.clothes_color));
			columns.push(new MyDataGridColumn("fightNum","战斗力",isHiLight,50));
			columns.push(new MyDataGridColumn("gunProperty1","gunProperty1",isHiLight,100));
			columns.push(new MyDataGridColumn("gunProperty2","gunProperty2",isHiLight,100));
			columns.push(new MyDataGridColumn("gunProperty3","gunProperty3",isHiLight,100));
			columns.push(new MyDataGridColumn("gunProperty4","gunProperty4",isHiLight,100));
		...
		public static function getColumnPackage(isHiLight:Boolean):Array{
			...
			columns.push(new MyDataGridColumn("description","Description",isHiLight,50));
			columns.push(new MyDataGridColumn("MType","素材类型",isHiLight,100));
			columns.push(new MyDataGridColumn("MValue","素材值",isHiLight,100));
...
//			columns.push(new MyDataGridColumn("mValue","素材值",isHiLight,50));
		...
		public static function getBlackIPColumns(hiLight:Boolean=false):Array{
				...
				id.editable=false;
				columns.push(id);
				columns.push(new MyDataGridColumn("ip","IP地址",hiLight,100));
				columns.push(new MyDataGridColumn("isBanned","是否被禁(“Y”禁止，“N”不禁止)",hiLight,200));
				...
				columns.push(new MyDataGridColumn("bannedTime","封禁时间(min)",hiLight,100));
				columns.push(new MyDataGridColumn("description","原因描述",hiLight,400));
				var createTime:MyDataGridColumn=new MyDataGridColumn("createTimeStr","创建时间",hiLight,200);
