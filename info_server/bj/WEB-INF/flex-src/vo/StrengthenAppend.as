package vo
{
	...
	public class StrengthenAppend
	{
		...
		private var _property1_db:Number=0;
		private var _property2_db:Number=0;
		...
		public function  set property1_db(value:Number):void{
			_property1_db=value;
		}
		public function get property1_db():Number{
			return Number(_property1_db.toFixed(3));
		}
		public function set property2_db (value:Number):void{
			_property2_db=value;
		}
		public function get property2_db():Number{
			return Number(_property2_db.toFixed(3));
		}
	}
}