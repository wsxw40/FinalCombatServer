...
public class ConfigurationUtil {
	...
	public static final List GM_USER_IDS = GM_USER_IDS_FLAG != null && GM_USER_IDS_FLAG.length() > 0 ? StringUtil.toList(GM_USER_IDS_FLAG.replace(Constants.XUNLEI_LOG_DELIMITER,
			Constants.DELIMITER_RESOURCE_STABLE)) : null;

	public static final int PLAYER_TRACK_TIMESTAMP = Integer.parseInt(config.getString("PLAYER_TRACK_TIMESTAMP"));

	//config.getString("suitProperties");
	public static final String LEAGUE_APPLY_START = config.getString("league_apply_start");
	public static final String LEAGUE_APPLY_END = config.getString("league_apply_end");
	public static final String LEAGUE_GAME_START = config.getString("league_game_start");
	public static final String LEAGUE_GAME_END = config.getString("league_game_end");
	public static final String LEAGUE_WEEKS = config.getString("league_weeks");
	public static final String LEAGUE_REMARK_1 = config.getString("league_remark_1");
	public static final String LEAGUE_REMARK_2 = config.getString("league_remark_2");
	//#0表示正常比赛，1表示训练赛
	public static final String LEAGUE_TYPE = config.getString("league_type");
	public static final String LEAGUE_SWITCH = config.getString("league_switch");
	...
	public static final String QW_SCOCE_CLEAN = config.getString("QW_SCOCE_CLEAN");
