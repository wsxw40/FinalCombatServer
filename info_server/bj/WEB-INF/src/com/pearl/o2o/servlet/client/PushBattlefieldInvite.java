	...
	protected String innerService(String... args) {
		...
		try {
			...
			for (Player receiver : receivers) {// 向每一玩家发出邀请
				//------2015年3月24号15点  赵连明--添加参数player_Res_ratio_status------------------------------------
				 //获得收益状态  1，为正常  2，为收益0.5 3.为收益零 
				int player_Res_ratio_status=1;
				String player_Res_ratio_status_key=Constants.PLAYER_RES_RATIO_STATUS+receiver.getId();
				...
				soClient.sendBattleFieldInvite(receiver, inviter, serverid,
						channelid, roomid, roompwd,	fightType,player_Res_ratio_status);
