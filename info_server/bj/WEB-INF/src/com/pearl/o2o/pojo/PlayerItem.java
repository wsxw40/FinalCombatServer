...
public class PlayerItem extends BaseMappingBean<PlayerItem> {
	...
	public void writeCostume(OutputStream out, SysItem sysItem, SysCharacter sysCharacter, int... suitArgus) throws Exception {
		...
		out.write(BinaryUtil.toByta((this.getCResistanceBlast_game() + this.sysItem.getCResistanceBlast())));
		out.write(BinaryUtil.toByta((this.getCResistanceBullet_game() + this.sysItem.getCResistanceBullet())));
		out.write(BinaryUtil.toByta((this.getCResistanceKnife_game() + this.sysItem.getCResistanceKnife())));
	...
	public void calculateTimeLeft() {
		...
		if (this.isBind.equals(Constants.BOOLEAN_NO)) {
			try {
				SysItem si = ServiceLocator.getService.getSysItemByItemId(itemId);
				if (si != null) {
					Integer type = si.getType();
					Integer sub_type = si.getSubType();
					if (!(null != type && null != sub_type && type == 4 && sub_type == 4)) {
	...
	public void calculateParam(SysItem sysItem) {
		...
		if (sysItem.getSubType() != 3) {
			if (sysItem.getWDamage() == 0) {
				...
				this.damange_game = (float) ((this.wDamage_game + 50) / 2);
			...
			if (sysItem.getWStabHurt() == 0) {
				...
				this.nextDamange = (this.level >= Constants.MAX_STRENGTH_LEVEL ? this.damange : (float) ((sysItem.getWStabHurt() * nextDamangeOffset + 50) / 2));
				//zlm_7_15装备属性start================================================================================
				this.wStabHurt_game = (int) (sysItem.getWStabHurt() * damageOffset_game);
				this.damange_game = (float) ((this.wStabHurt_game + 50) / 2);
				this.nextDamange_game = (this.level >= Constants.MAX_STRENGTH_LEVEL ? this.damange_game : (float) ((sysItem.getWStabHurt() * nextDamangeOffset_game + 50) / 2));
				//zlm_7_15装备属性end==========
			}
		}
		...
		if (sysItem.getSubType() != 3) {
			if (sysItem.getWFireTime() == 0) {
				...
				this.nextShootSpeed = (this.level >= 15 ? this.shootSpeed : (float) ((1 / sysItem.getWFireTime() * nextShootSpeedOffset) * 10));
				//zlm_7_15装备属性start================================================================================
				...
				this.nextShootSpeed_game = (this.level >= 15 ? this.shootSpeed_game : (float) ((1 / sysItem.getWFireTime() * nextShootSpeedOffset_game) * 10));
				//zlm_7_15装备属性end=============================
			}
		} else {
			if (sysItem.getWStabTime() == 0) {
				...
				this.nextShootSpeed = (this.level >= 15 ? this.shootSpeed : (float) (((1 / sysItem.getWStabTime()) * nextShootSpeedOffset) * 10));
				//zlm_7_15装备属性start================================================================================
				...
				this.nextShootSpeed = (this.level >= 15 ? this.shootSpeed_game : (float) (((1 / sysItem.getWStabTime()) * nextShootSpeedOffset_game) * 10));
				//zlm_7_15装备属性end=============================
			}
		}
