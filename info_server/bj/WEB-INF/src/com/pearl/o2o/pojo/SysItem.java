...
//						}
	...
	private void calculateAppendStr4Des(){
		...
		if (getIsStrengthen() != 0 && this.getStrengthLevel()>0) {
			this.cResistanceFire_add = (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 0)) * 100 * (1 + 0.01 * this
					.getCResistanceFire()));
			this.cResistanceBlast_add = (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 0)) * 100 * (1 + 0.01 * this
					.getCResistanceBlast()));
			this.cResistanceBullet_add = (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 0)) * 100 * (1 + 0.01 * this
					.getCResistanceBullet()));
			this.cResistanceKnife_add = (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 0)) * 100 * (1 + 0.01 * this
					.getCResistanceKnife()));
			this.cBloodAdd_add = (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 1)) * 100 * (1 + 0.01 * this
					.getCBloodAdd()));
			//zlm_7_15装备属性start================================================================================
			this.cResistanceFire_add_game 	= (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 10)) * 100 * (1 + 0.01 * this.getCResistanceFire()));
			this.cResistanceBlast_add_game 	= (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 10)) * 100 * (1 + 0.01 * this.getCResistanceBlast()));
			this.cResistanceBullet_add_game = (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 10)) * 100 * (1 + 0.01 * this.getCResistanceBullet()));
			this.cResistanceKnife_add_game 	= (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 10)) * 100 * (1 + 0.01 * this.getCResistanceKnife()));
			this.cBloodAdd_add_game 		= (float) ((ServiceLocator.getService
					.getStrengthenProperty(this, getStrengthLevel() - 1, 11)) * 100 * (1 + 0.01 * this.getCBloodAdd()));
			//zlm_7_15装备属性end==========
			...
			this.showDamage_game 		= (float) (((int) (getWDamage() * damageOffset_game) + 50) / 2);
