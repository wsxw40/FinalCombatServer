...
public class SocketClientNew {
	...
	public  void messageXLB(int serverId, int channelId, String msg, String name) throws IOException{
		channelBroadCast(serverId, channelId,Constants.MSG_XLB, name, msg);
	}
	
	public  void messageDLB(int serverId, String msg, String name) throws Exception{
		serverBroadCast(serverId, Constants.MSG_DLB, name, msg);
	}
...
//		logger.debug("update achievement completed="+cmdStr);
	 ...
	 * @throws IOException 
	 */
	public void sendBattleFieldInvite(Player receiver, Player inviter,int serverid,int channelid,int roomid,String roompwd,FightType fightType) throws IOException{
		String message=Converter.getBattleFiledInvitation(receiver, inviter, serverid, channelid, roomid, roompwd,fightType);
	...
	public void kickPlayer(int playerId)throws Exception{
		ByteArrayOutputStream out = new ByteArrayOutputStream();
