...
public class Converter {
	...
	public static String misticAward(OnlineAward misticAward){
		String value = "";
		try{
			Context ctx	= new Context();
	...
	//daily check
	public static String dailyGift(String msg,List<OnlineAward> items,int isGift) {
		String value = "";
		try{			
			Context ctx		 = new Context();
			ctx.set("msg", msg);
	...
	public static String dailyCheckList(String date,int day,List<String> checkList,
			List<SysItem> items,int today,String myNum,String tomorrow,int isGift,int isShowAward, int freeCheckTimes) {
		String value = "";
		try{			
			Context ctx = new Context();
			ctx.set("date", date);
	...
	// online award
	public static String onlineAward(int leftSecond,String next,List<OnlineAward> gifts,String errorMsg) {
		String value = "";
		try{			
			Context ctx		 = new Context();
	...
	public static String playerInfo(Player player,  List news ,int top){		
		String value = "";
	...
	public static String fontPlayerInfo(Player player,int emailNum,
			int teamRequestNum,String erroMsg,int card,PlayerInfo playerInfo,int top, float winRate,String team,int maxLevel,int vipLeftMins){		
		String value = "";
...
//		}
	...
	public static String exchangeSysItemList(int page,int pages,List<SysItem> list,int rank,int chipNum){
		String value = "";
		try{
			Context ctx		 = new Context();
			ctx.set("page", page);
	...
	public static String combineItemList(int page,int pages,List<PlayerItem> list,int rank){		
		String value = "";
...
//	}
	 ...
	 * @return
	 */
	public static String getBattleFiledInvitation(Player receiver, Player inviter,int serverid,int channelid,int roomid,String roompwd,FightType fightType){
		String value = "";
	...
	public static String dailyDiscoutItem(SysItem si, String flag, String discounts) {
		String value="";
		try{
			Context ctx		 = new Context();
			ctx.set("theItem", si);
...
//			ctx.set("items", items);
	...
	public static String GetVipInfo(int vipLevel,int currentExp, int leftMins,int nextLevelExp,SysItem vipItem){
		String value="";
		try{
			Context ctx		 = new Context();
	 ...
	 * @return
	 */
	public static String GetMatchedTeam(Team team, TeamLevelInfo teamLevelInfo,boolean outOfCount,boolean outOfStones,int canRobUnuseRes) {
		String value = "";
		try {
			if (outOfCount) {
				Context ctx = new Context();
