...
public class Constants {
	...
	//vip buff,the id is duplicate, TODO: change it to 83
	public static final int DEFAULT_VIP_STRENGTH_BUFF		=81;	
	//team item
...
//	public static final int MAX_WEAPON_PACK_SIZE    		= 5;
	...
	public static final int TYPE_NUM                	= 9;//The max number of SYS_ITEM.TYPE
...
//	public static final int WEAPON_MED_GUN_ID			= 12;//医疗塔
	...
	public static final int RES_PAY                     = 5;//个人黑曜石
	public static final int RES_PAY_TEAM                = 6;//团队黑曜石
	...
	public static enum GAMETYPE{
		...
		BIOCHEMICAL2(11),HITBOSS2(12),AMAZINGWAR(13),TEAMEDIT(14),TEAMZYZDZ(15);
		private int value;
		GAMETYPE(int value){
			this.value = value;
		}
	...
	public enum ACTION_ACTIVITY{
		...
		STRENGTH_MUST(23),KILL_BOSS2_ACTIVITY(24),TEAM_BATTLE_ADD(25),
	...
	public static double[] gameTypeNum={
		1.1,1.3,1.3,1,0.6,1.9,1.2,0.6,0.7,1.1,0.7,1.0,1.0,1.2
	};
	//default item
	...
	public static enum DAILY_CHECK_AWARD_LEVEL{
		PRIMARY_CHECK(1),MIDDLE_CHECK(2),HIGH_CHECK(3),SUPER_CHECK(4),DAILY_GIFT(5),DAILY_GUESS(6);
		private int value;
	...
	/*
	 * 1 在线时长
	 * 2 每日签到 3 神秘锦囊 4 VIP保险箱 5 密码箱 6 过关结算翻牌子 7 靶场 8 连续射击（银） 9 连续射击（金） 10 彩盒 11 拼图  12资源争夺战兑换礼盒
	 */
	public enum ONLINE_AWARD_TYPES{
		ONLINE_TIME(1),DAILY_CHECK(2),MYSTIC_BAG(3),VIP_SAFECABINET(4),PASSWARD_BOX(5),
		STAGE_CLEAR(6),SHOOTING_AWARD(7),SILVER_DARTLE_AWARD(8),GOLD_DARTLE_AWARD(9),LUCK_PACKAGE(10),MISTIC_PINTU(11),RES_MAGIC_BOX(12);
		private int value;
	...
	public static final int[] VIP_EXTRA_GP_PERCENT = {50,70,90,110,130,150};
	public static final int[] VIP_EXTRA_EXP_PERCENT = {50,70,90,110,130,150};
	...
	public static int[][][] GREEN_ITEM_AWARD={
		...
		{//lv25
			{125,1,55},{127,1,1},{4479,1,110},{126,1,1},{4643,1,1}
		},
		{//lv30
...
//			终止在三十级,{4644,1,1}
	...
	public static final int MAX_STRENGTH_LEVEL = 15;
	public static final int MAX_STRENGTH_LEVEL_DEFAULT = 10;
	public static final int MAX_STRENGTH_LEVEL_DEFAULT_FOR_VIP5 = 11;
	public static final int MAX_STRENGTH_LEVEL_DEFAULT_FOR_VIP6 = 12;
	...
	public static final Integer[] DAILY_DISCOUNT_SYSITEM_IDS = {4879};
...
//	};
	...
	//不同vip等级所需经验
	public static final int[] VIP_LEVEL_EXP={0,18240,52800,115840,216000,361920};
	//vip 每日，每周任务多获得的奖励百分比
	public static final int[] VIP_MISSION_EX_EARN_PER={50,60,70,80,90,100};
	//vip 退出战队保留战队经验百分比
	public static final int[] VIP_REMAINS_TEAM_EXP_PER={30,40,50};
	//vip 每日战队战可或贡献上限增加值
	public static final int[] VIP_TEAM_EXP_ADD={100,200,400};
	//vip 充能额外获得百分比
	public static final float[] VIP_BURN_EX_EARN_PER={1.5f,1.6f,1.7f,1.8f,1.9f,2.0f};
	//vip 各种行为获得的升级经验
	//签到  , 在线时长 , 每日任务 , 过关结算
	...
	//vip 额外增加的强化成功率
	public static final int[] VIP_STRENGTHEN_EX_PER={5,10,15};
	...
	public static class TeamSpaceConstants {
		...
		/** 进行匹配玩家所消耗的黑曜石数量 */
		public static final int MATCH_COST_STONES = 10;		
		...
		/** 匹配每局时长 */
		public static final int BATTLEFIELD_CACHE_GAMEROUND_LIFE_TIMEOUT = 480;// 6分钟
		...
		public static int getChallengeFCCostByKSZY(int hillLeftZY){
			Double add=hillLeftZY/25*0.05*0.5*100;
			return add.intValue();
		}
		...
		public static final int PERSON_BASE_NON_CONVERT_RES=2000;  //个人 转换时 的下限
...
//	} 
	...
	public static final float DEF_PERCENT_AT_END_OF_ZYZDZ=2/3f;			//防守 方奖励力度
	public static final float ATT_WINNER_ADDED_PER_AT_END_OF_ZYZDZ=0.1f; //进攻胜利方 额外加成
	public static final float DEF_WINNER_ADDED_PER_AT_END_OF_ZYZDZ=2f; //防守胜利方 额外加成
