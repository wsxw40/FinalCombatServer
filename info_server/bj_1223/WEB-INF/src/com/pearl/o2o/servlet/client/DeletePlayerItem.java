...
public class DeletePlayerItem extends BaseClientServlet {
	...
	protected String innerService(String... args) {
		try{
			...
			infoLogger.log(LogServerMessage.deletePlayerItem.name(), Level.INFO_INT, LogUtils.JoinerByTab.join("",playerId,playerItemId,pi.getSysItem().getDisplayNameCN(),type));
