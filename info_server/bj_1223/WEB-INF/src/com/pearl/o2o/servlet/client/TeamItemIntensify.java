...
public class TeamItemIntensify extends BaseClientServlet{
	...
	protected String innerService(String... strings) {
		...
		StringBuffer sb = new StringBuffer(playerId+"|"+teamItemId+"|"+currency+"|"+intensifyType+"|"+DateUtil.df.format(System.currentTimeMillis())+"|");
		try {
			//检测是否输过二级密码
...
//			int isUp = 0;
			...
			if(currency ==Constants.CR_PAY){
				...
				playerInfo.setXunleiPoint(playerInfo.getXunleiPoint()-cost);
				...
				team.setUsableResource(teamRes.get(Team.RES)-cost);
