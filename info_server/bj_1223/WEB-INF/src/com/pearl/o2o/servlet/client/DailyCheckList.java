...
//			System.out.println("DailyCheckList  checkedTimes="+checkedTimes);
			return Converter.dailyCheckList(dateStr, date.get(Calendar.DAY_OF_WEEK)-Constants.NUM_ONE,playerCheckList,checkItemList ,todayNum ,playerNums,tomorrows,isGift,isShowAward,freeCheckTimes);
