		...
		try{
			...
			if(ti.isUpgrade(ti.getSysItem().getSubType())){
				...
				try{
					...
					newTeamItem = createService.createTeamItem(team.getId(), sysItem, ti.getShowQuantity(), ti.getUnitType(), ti.getIsGift(), ti.getIsBind(), ti.getIsDefault(),ti.getUsedCount());
