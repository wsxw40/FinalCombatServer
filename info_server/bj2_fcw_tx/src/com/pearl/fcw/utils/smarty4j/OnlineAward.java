...
public class OnlineAward implements Ctx {
...
sb.append("time=");
sb.append(context.get("leftSecond"));
sb.append(" ");
sb.append("\r\n");
sb.append("currentExp = ");
sb.append(context.get("cExp"));
sb.append(" ");
sb.append("\r\n");
sb.append("award_time=\"");
sb.append(context.get("next"));
sb.append("\" ");
sb.append("\r\n");
sb.append("items={ ");
sb.append("\r\n");
List gifts509 = new ArrayList<>();
if (null!=context.get("gifts")){
if (context.get("gifts") instanceof List) gifts509=(List<?>)context.get("gifts");
else if (context.get("gifts") instanceof int[]) gifts509=Stream.of((int[])context.get("gifts")).collect(Collectors.toList());
else if (context.get("gifts") instanceof long[]) gifts509=Stream.of((long[])context.get("gifts")).collect(Collectors.toList());
else if (context.get("gifts") instanceof float[]) gifts509=Stream.of((float[])context.get("gifts")).collect(Collectors.toList());
else if (context.get("gifts") instanceof double[]) gifts509=Stream.of((double[])context.get("gifts")).collect(Collectors.toList());
else if (context.get("gifts") instanceof byte[]) gifts509=Stream.of((byte[])context.get("gifts")).collect(Collectors.toList());
else if (context.get("gifts") instanceof String[]) gifts509=Stream.of((String[])context.get("gifts")).collect(Collectors.toList());
else if (context.get("gifts").getClass().isArray()) gifts509=Stream.of(context.get("gifts")).collect(Collectors.toList());
}
gifts509.forEach(theItem->{
try{
sb.append("	{ ");
sb.append("\r\n");
sb.append("		sid=");
...
sb.append("\r\n");
List theItemsysItemcharacterList313 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")){
if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof List) theItemsysItemcharacterList313=(List<?>)O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList");
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof int[]) theItemsysItemcharacterList313=Stream.of((int[])O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof long[]) theItemsysItemcharacterList313=Stream.of((long[])O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof float[]) theItemsysItemcharacterList313=Stream.of((float[])O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof double[]) theItemsysItemcharacterList313=Stream.of((double[])O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof byte[]) theItemsysItemcharacterList313=Stream.of((byte[])O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList") instanceof String[]) theItemsysItemcharacterList313=Stream.of((String[])O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
else if (O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList").getClass().isArray()) theItemsysItemcharacterList313=Stream.of(O2oUtil.getSmarty4jProperty(theItem,"sysItem.characterList")).collect(Collectors.toList());
}
theItemsysItemcharacterList313.forEach(ids->{
try{
sb.append("				");
sb.append(ids);
sb.append(",  ");
...
sb.append("\", ");
sb.append("\r\n");
Context includeContextVar6279=new Context();
includeContextVar6279.set("unitType",O2oUtil.getSmarty4jProperty(theItem,"unitType"));
includeContextVar6279.set("unit",O2oUtil.getSmarty4jProperty(theItem,"unit"));
sb.append(new Timelimit().get(includeContextVar6279));
...
sb.append("} ");
sb.append("\r\n");
if( (O2oUtil.compare(context.get("errorMsg"),"!=",null))){
sb.append("	error=\"");
sb.append(context.get("errorMsg"));
sb.append("\"  ");
sb.append("\r\n");
} else {
sb.append("	error=nil  ");
