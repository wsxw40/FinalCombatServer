...
public class WSysItem extends DmModel {
    ...
    public Byte getwAutoFire() {
        return wAutoFire;
    }

    public void setwAutoFire(Byte wAutoFire) {
    ...
    public Byte getwXOffset() {
        return wXOffset;
    }

    public void setwXOffset(Byte wXOffset) {
    ...
    public Boolean getIsStrengthen() {
        return isStrengthen;
    }

    public void setIsStrengthen(Boolean isStrengthen) {
