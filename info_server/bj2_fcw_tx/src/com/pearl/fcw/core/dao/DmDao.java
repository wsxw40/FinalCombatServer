...
public interface DmDao<M extends BaseEntity, ID extends Serializable> {
    ...
    /**
     * 查找一条数据。对应xml中的statement:selectByPrimaryKey
     * @param id
     * @return
     */
    public M findEntity(final M m) throws Exception;
     ...
     * @throws Exception
     */
    public ID getEntityId(M t) throws Exception;
}
