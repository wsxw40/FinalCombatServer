...
import com.pearl.o2o.dao.impl.nonjoin.SysMatchPDao;
...
public class BaseService {
	...
	protected PlayerTrackDao		playerTrackDao;
	...
	//zlm2015-10-9-匹配-开始 
	protected SysMatchPDao sysMatchPDao;

	public SysMatchPDao getSysMatchPDao() {
		return sysMatchPDao;
	}

	public void setSysMatchPDao(SysMatchPDao sysMatchPDao) {
		this.sysMatchPDao = sysMatchPDao;
	}
	//zlm2015-10-9-匹配-结束
	...
	public PlayerTrackDao getPlayerTrackDao() {
		return playerTrackDao;
	}
	public void setPlayerTrackDao(PlayerTrackDao playerTrackDao) {
		this.playerTrackDao = playerTrackDao;
	}
