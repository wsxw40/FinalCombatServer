...
import com.pearl.o2o.servlet.server.Get_FCM_info;
...
public  class BaseClientServlet extends HttpServlet {
	...
	//ne
	protected  String innerService(String... strings){return "";};
	protected  String[] paramNames(){return new String[0];};
	protected  String getLockKey(String[] paramNames){return null;};
	...
	public List<Response> execute(Map<String, String> params) throws MemcachedException, TimeoutException, Exception{
		...
		//========反沉迷start===============================
		if (playerId!=-1) 
			time = Get_FCM_info.getTime(playerId);
		//========反沉迷end=================================
