			...
			<div id="tab">
				...
				<div id="tabs-15">
					...
					<div class="form-group">
						...
						<div class="col-sm-4" title="<fmt:message key="web.gm.sysItems.col.items.toolTips"/>">
							<input class="form-control" id="items" ng-model="items"  name="items"placeholder="<fmt:message key="web.gm.sysItems.col.items.toolTips"/>" />
						</div>
						<label for="backBoostPlus" class="col-sm-2 control-label"><fmt:message key="web.gm.sysItems.col.backBoostPlus.title"/></label>
					</div>
					<div class="form-group">
