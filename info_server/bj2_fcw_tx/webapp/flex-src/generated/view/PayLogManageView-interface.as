...
public class PayLogManageView extends mx.containers.VBox
{
	public function PayLogManageView() {}

	[Bindable]
	public var getRo : mx.rpc.remoting.mxml.RemoteObject;
	[Bindable]
	public var showPayLogView : mx.controls.Button;
	[Bindable]
	...
	[Bindable]
	public var payLogListPanel : mx.containers.Panel;
	[Bindable]
	public var payLogView : view.PayLogView;
...
include "D:/info_server/bj/WEB-INF/flex-src/view/PayLogManageView.mxml:7,168";
