...
//	}
	...
	@SuppressWarnings("unchecked")
	public List<GmUser> getGmUsersByGroupIds(List<Integer> groupIds){
		Map<String,Object> param = new HashMap<String,Object>();
		param.put("groupIds",StringUtils.join(groupIds, ","));
		return this.getSqlMapClientTemplate().queryForList("GmUser.selectGmUserByGroupIds", param);
	}
