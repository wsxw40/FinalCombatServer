 ...
 * 无返回数据
 */
public class s_random_player extends SM_ResponseBinaryRPC {

	public s_random_player(int userDataLength) {
	...
	public String toString() {
		return "s_random_player [queueId=" + queueId + ", queueCurrentSize=" + queueCurrentSize + ", rpcId=" + rpcId + ", statusCode=" + statusCode + ", type=" + type + ", datalength=" + datalength + "]";
	}
