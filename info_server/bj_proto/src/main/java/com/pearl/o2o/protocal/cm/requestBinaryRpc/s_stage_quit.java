 ...
 * 
 */
public class s_stage_quit extends CM_RequestBinaryRPC {
	...
	private final void fillPlayerInfoListTeam(ChannelBuffer message) {
	...
	public String toString() {
		return "s_stage_quit [playerId=" + playerId + ", rid=" + rid + ", serverId=" + serverId + ", channelId=" + channelId + ", hostId=" + hostId + ", type=" + type
				+ ", gameStart=" + gameStart + ", gameEnd=" + gameEnd + ", levelId=" + levelId + ", winner=" + winner + ", terroristScore=" + terroristScore + ", policeScore="
				+ policeScore + ", mvpId=" + mvpId + ", firstKill=" + firstKill + ", firstDead=" + firstDead + ", itemType=" + itemType + ", playerInfoListTeam="
				+ Arrays.toString(playerInfoListTeam) + ", queueId=" + queueId + ", rpcId=" + rpcId + ", url=" + url + ", userData=" + Arrays.toString(userData) + ", datalength=" + datalength + "]";
	}
