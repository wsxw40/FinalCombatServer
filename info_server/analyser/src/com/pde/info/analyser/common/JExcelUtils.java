...
public class JExcelUtils {
	...
	public void createExcelFile(String path, String sheetName,
		...
		try {
			...
			mergeCellsAndInsertData(sheet, 0, 5, 0, 6, "Datex", getDataCellFormat(CellType.STRING_FORMULA));
	...
	public void mergeCellsAndInsertData(WritableSheet sheet, Integer col_start,
			Integer row_start, Integer col_end, Integer row_end, Object data, WritableCellFormat format) {
	...
	public ArrayList<String> readDataFromExcel(File inputFile,
		...
		setting.setEncoding("UTF-8");//("ISO-8859-1");
		try {
	...
	public static void main(String[] args) {
		...
		jxl.openExcel("C:\\Program Files (x86)\\Microsoft Office\\Office14\\EXCEL.EXE", filePath);
	}
}
