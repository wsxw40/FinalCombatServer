...
public class Melting extends BaseClientServlet {
	...
	protected String innerService(String... args) {
		try {
            ...
            String hashGet = ServiceLocator.nosqlService.getNosql().hashGet(key, playerId + "");
            double n_count = hashGet == null ? 0 : Integer.valueOf(hashGet);// 获得次数
            int recycle_ratio = n_count > 10 ? (int) (Math.pow(0.7, (n_count / 10)) * 100 + 0.49) : 100;
			return Converter.getMeltingResult(meltingResult,recycle_ratio);
