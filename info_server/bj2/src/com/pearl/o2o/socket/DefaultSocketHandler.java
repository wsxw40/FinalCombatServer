...
//	private static HashSet<String> spiteIpSet=new HashSet<String>();
	@Override
    public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) {
		ConfigurationUtil.CHANNEL_HANDLERS.registChannel(this);
    	log.error("channel " + e.getChannel().getRemoteAddress().toString() + "connected ");
    	//start thread
...
//							final String spiteIp=channel.getRemoteAddress().toString();
//							if(!spiteIpSet.contains(spiteIp)){
//								spiteIpSet.add(spiteIp);
//								log.warn("wrong package head   "+BinaryUtil.toChar(headtip)+"    "+spiteIp);
//								log.warn("wrong package head   "+BinaryUtil.toChar(headtip));
//							}
...
//			    int queueSize=buf.readInt();
	...
	public void channelDisconnected(ChannelHandlerContext ctx,
		...
		log.error("channel " + e.getChannel().getRemoteAddress().toString() + "disconnected ");
	...
	public void channelClosed(ChannelHandlerContext ctx, ChannelStateEvent e)
			throws Exception {
		log.error("channel " + e.getChannel().getRemoteAddress().toString() + "close ");
    	ConfigurationUtil.CHANNEL_HANDLERS.removeChannel(this);
    	requestExec.shutdown();
    	returnExec.shutdown();
	}
