...
public class StringUtil {
	...
	/**
	 * 鐢ㄤ簬鏇挎崲瀛楃涓蹭腑鎸囧畾浣嶇疆鐨勫瓧绗︼紝濡傛灉鎸囧畾浣嶇疆澶т簬瀛楃涓茬殑闀垮害锛屽垯鏇挎崲鏈�鍚庝竴涓瓧绗�
	 * @param str <code>鐩爣瀛楃涓�</code>
	 * @param index <code>鎸囧畾浣嶇疆</code>
	 * @param c <code>鏇挎崲瀛楃</code>
	...
	/**
	 * @param string
	 * @param type 0:姝ｆ暣鏁�,1:姝ｈ礋鏁存暟,2:姝ｆ诞鐐规暟,3:姝ｈ礋娴偣鏁�
	 * @return
	 */
	 ...
	 * @return
	 */
	public static int[] strsToInts (String str, int size,String str2){
	 ...
	 * @return
	 */
	public static int[] strsToInts (String str,String str2){
		String[] strs = str.split(str2);
	 ...
	 * @return
	 */
	public static String intsJoint(int[] ints, String str){
		if (ints==null||ints.length<=0) {
			return null;
		}
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < ints.length-1; i++) {
			sb.append(ints[i]).append(str);
