...
public class CacheUtil {
	...
	public static String oPlayerTeam(int teamID){
		return new StringBuilder(Constants.OBJECT_TYPE).append(Constants.DELIMITER).append(teamID).toString();
	}
	...
	public static String isRunTeamCheckTask(){
		return new StringBuilder(Constants.OBJECT_TYPE).append(Constants.DELIMITER).append(Constants.SYN_TEAM_CHECK).toString();
	}
	public static String isRunTeamResSendTask(){
		return new StringBuilder(Constants.OBJECT_TYPE).append(Constants.DELIMITER).append(Constants.WEEKLY_SEND_TEAM_RES).toString();
	}
	...
	public static String oTeamLevelList(){
		return new StringBuilder(Constants.OBJECT_TYPE).append(Constants.TEAM_LEVEL_LIST).toString();
	}
	...
	public static String oTeamItem(int teamItemId){
		return new StringBuilder(Constants.OBJECT_TYPE).append(Constants.TEAM_ITEM).append(Constants.DELIMITER).append(teamItemId).toString();
	}	
	public static String oSimpleTeam(int teamId){
		return new StringBuilder(Constants.OBJECT_TYPE).append(Constants.STRING_TYPE).append(Constants.TEAM).append(Constants.DELIMITER).append(teamId).toString();
	}
	 ...
	 * @return
	 */
	public static String getTeamExpKey(Integer rid, Integer channelId, Integer serverId,Integer playerId){
		return new StringBuilder(Constants.STRING_TYPE)
				.append(Constants.STAGECLEAR).append(Constants.DELIMITER)
				.append(rid).append(Constants.DELIMITER).append(channelId)
				.append(Constants.DELIMITER).append(serverId)
...
//	}
	...
	public static String sLuckyPackagePage(int level,int pageNo){
		return new StringBuffer(Constants.STRING_TYPE).append(Constants.DELIMITER).append(Constants.LUCKYPACKAGE).append(Constants.DELIMITER).append(Constants.DELIMITER)
...
//		return Constants.STRING_TYPE+Constants.DELIMITER+Constants.LUCKYPACKAGE+Constants.DELIMITER+Constants.DELIMITER+level+Constants.DOT+pageNo;
	...
	public static String sLuckyPackageRandomNames(int level){
		return new StringBuffer(Constants.STRING_TYPE).append(Constants.DELIMITER).append(Constants.LUCKYPACKAGERANDOMNAMES).append(Constants.DELIMITER).append(Constants.DELIMITER).append(level).toString();
//		return Constants.STRING_TYPE+Constants.DELIMITER+Constants.LUCKYPACKAGERANDOMNAMES+Constants.DELIMITER+Constants.DELIMITER+level;
	...
	public static String isBurnt(int playerId){
		return JoinerByUnderScore.join("ISBURNT",playerId);
	}
	public static String strengtFailTimes(int playerId, int playerItemId){
		return new StringBuffer(Constants.STRING_TYPE).append(Constants.DELIMITER).append(Constants.STRENGTH_FAIL_TIME).append(Constants.DELIMITER).append(playerId)
	...
	public static final long zone = 1000L*60*60*((Calendar.getInstance().get(Calendar.ZONE_OFFSET) + Calendar.getInstance().get(Calendar.DST_OFFSET))/(60*60 * 1000));
	public static boolean isToday(long milliseconds){
		return (System.currentTimeMillis()+zone)/OneDayMilliseconds == (milliseconds+zone)/OneDayMilliseconds;
	}
	
	public static String sPlayerSPWIE(int playerId){
		return new StringBuffer(Constants.STRING_TYPE).append(Constants.DELIMITER).append(Constants.SECOND_PASSWORD_IS_ENTER).append(Constants.DELIMITER).append(playerId).toString();
	}
	
//	public static String sVipDailyExpStatus(){
//		return new StringBuffer(Constants.STRING_TYPE).append(Constants.DELIMITER).append(Constants.VIP_UPGRADE_EXP_STATUS).toString();
//	}
	
	public static String oTeamLevelByTeam(int teamId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.TEAM_LEVEL_LIST).append(Constants.DELIMITER).append(teamId).toString();
	}
	public static String oTeamLevelByTL(int teamId,int refLevelId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.TEAM_LEVEL_LIST).append(Constants.DELIMITER).append(teamId).append(Constants.DELIMITER).append(refLevelId).toString();
	}

	public static String sPlayerItemsTopLimitCGold(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITCGOLD).append(Constants.DELIMITER).append(playerId).toString();
	}
	public static String sPlayerItemsTopLimitMerit(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITMERIT).append(Constants.DELIMITER).append(playerId).toString();
	}
	public static String sPlayerItemsTopLimitStrength(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITSTRENGTH).append(Constants.DELIMITER).append(playerId).toString();
	}
	public static String sPlayerItemsTopLimitBoxA(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITBOXA).append(Constants.DELIMITER).append(playerId).toString();
	}
	public static String sPlayerItemsTopLimitBoxB(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITBOXB).append(Constants.DELIMITER).append(playerId).toString();
	}
	public static String sPlayerItemsTopLimitBoxC(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITBOXC).append(Constants.DELIMITER).append(playerId).toString();
	}
	public static String sPlayerItemsTopLimitBoxD(int playerId){
		return new StringBuffer(Constants.OBJECT_TYPE).append(Constants.PLAYERITEMSTOPLIMITBOXD).append(Constants.DELIMITER).append(playerId).toString();
	}
}
