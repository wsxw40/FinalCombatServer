...
public class Converter {
 ...
 int teamRequestNum, String erroMsg, int card, PlayerInfo playerInfo, int top, float winRate, String team, int maxLevel,
			int vipLeftMins, int currentyEXPItem, float maxDuration) {
        String value = "";
        ...
        try {
			...
			ctx.set("maxDuration", maxDuration);
	 ...
	 */
	public static String exchangeSysItemList(int page, int pages,
			List<SysItem> list, int rank, int chipNum, int reviceCoinNum,
			int aChipNum, int bChipNum, int cChipNum) {
        String value = "";
        try {
            Context ctx = new Context();
            ctx.set("page", page);
	...
	public static String playerItemList(int page, int pages, List<PlayerItem> list, int rank, float maxDuration) {
        String value = "";
    ...
    public static String completeMissionList(List<PlayerMission> list) {
        ...
        try {
            ...
            ctx.set("flag", 1);
			//FCW 页游采用有逗号的脚本
            value.append(sm.getEncodedBody("MissionListCmd.st", ctx));
        } catch (Exception e) {
            log.warn("Error in Convertor: ", e);
        }
        value.append("}");
    ...
    public static String League(String apply_start, String apply_end, String game_start, String game_end, String remark_1, String remark_2, String teamName, int haveTeam, int job, int apply,
            int start, int timeDiff, int timeDiffType,int gameType) {
        String value = "";
        try {
            Context ctx = new Context();
