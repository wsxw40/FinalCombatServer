...
public class WSysCharacter extends DmModel {
    ...
    private List<String> resourcePList = new ArrayList<>();
    ...
    public List<String> getResourcePList() {
        return resourcePList;
    }

    public void setResourcePList(List<String> resourcePList) {
        this.resourcePList = resourcePList;
    }
