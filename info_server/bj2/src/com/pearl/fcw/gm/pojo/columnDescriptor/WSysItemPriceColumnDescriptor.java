...
/**
 * SysItemPrice表的特殊字段描述
 */
public class WSysItemPriceColumnDescriptor extends ColumnDescriptor<WSysItemPrice> {

	@Override
	public WSysItemPrice get(WSysItemPrice m) {
		if (null == m) {
			return m;
		}
	...
	@Override
	public void set(WSysItemPrice m) {
	}
