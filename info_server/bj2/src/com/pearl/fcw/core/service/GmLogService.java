        ...
        try {
            ...
            for (Object arg : args) {
                if (null != arg && arg instanceof DmModel) {
                    ...
                    BaseEntity m = dao.findEntityByPrimaryKey(((DmModel) arg).getId());
                    oldList.add(m);
    ...
    public Object delete(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            for (Object arg : args) {
                if (null != arg && arg instanceof DmModel) {
                    CacheDao<?, ?> dao = CacheDao.getModelAndDaoMap().get(arg.getClass());
                    BaseEntity m = dao.findEntityByPrimaryKey(((BaseEntity) arg).getId());
                    oldList.add(m);
                    newList.add(null);
                } else if (null != arg && arg instanceof GmUser) {
                    gmUser = (GmUser) arg;
                ...
                if (null != arg && arg instanceof DmModel) {
                    ...
                    for (Object o : list) {
                        if (null != o && o instanceof DmModel) {
                            ...
                            BaseEntity m = dao.findEntityByPrimaryKey(((BaseEntity) o).getId());
                            oldList.add(m);
                        }
                    }
                } else if (null != arg && arg instanceof GmUser) {
