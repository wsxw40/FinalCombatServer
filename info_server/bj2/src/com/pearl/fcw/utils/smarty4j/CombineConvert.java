...
sb.append("\r\n");
List fromItemsysItemcharacterList377 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.characterList")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.characterList") instanceof List) fromItemsysItemcharacterList377=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.characterList");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.characterList").getClass().isArray()) fromItemsysItemcharacterList377=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.characterList")).collect(Collectors.toList());
}
fromItemsysItemcharacterList377.forEach(ids->{
try{
sb.append("				");
sb.append(ids);
sb.append(",  ");
...
sb.append("\r\n");
List fromItemgunPropertypropertyList515 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.propertyList")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.propertyList") instanceof List) fromItemgunPropertypropertyList515=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.propertyList");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.propertyList").getClass().isArray()) fromItemgunPropertypropertyList515=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.propertyList")).collect(Collectors.toList());
}
fromItemgunPropertypropertyList515.forEach(property->{
try{
sb.append("			{ ");
sb.append("\r\n");
...
sb.append("\r\n");
List fromItemgunPropertystrPropertyList974 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.strPropertyList")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.strPropertyList") instanceof List) fromItemgunPropertystrPropertyList974=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.strPropertyList");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.strPropertyList").getClass().isArray()) fromItemgunPropertystrPropertyList974=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"gunProperty.strPropertyList")).collect(Collectors.toList());
}
fromItemgunPropertystrPropertyList974.forEach(property->{
try{
sb.append("				{index= ");
...
sb.append("		parts = { ");
sb.append("\r\n");
List fromItemparts125 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"parts")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"parts") instanceof List) fromItemparts125=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"parts");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"parts").getClass().isArray()) fromItemparts125=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"parts")).collect(Collectors.toList());
}
fromItemparts125.forEach(part->{
try{
sb.append("			{");
...
sb.append("		gpprices={ ");
sb.append("\r\n");
List fromItemsysItemgpPricesList676 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.gpPricesList")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.gpPricesList") instanceof List) fromItemsysItemgpPricesList676=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.gpPricesList");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.gpPricesList").getClass().isArray()) fromItemsysItemgpPricesList676=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.gpPricesList")).collect(Collectors.toList());
}
fromItemsysItemgpPricesList676.forEach(pay->{
try{
sb.append("	    		{id=");
...
sb.append("		crprices={ ");
sb.append("\r\n");
List fromItemsysItemcrPricesList125 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.crPricesList")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.crPricesList") instanceof List) fromItemsysItemcrPricesList125=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.crPricesList");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.crPricesList").getClass().isArray()) fromItemsysItemcrPricesList125=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.crPricesList")).collect(Collectors.toList());
}
fromItemsysItemcrPricesList125.forEach(pay->{
try{
sb.append("	    		{id=");
sb.append(O2oUtil.getSmarty4jPropertyNil(pay,"id"));
sb.append(",unittype=");
...
sb.append("\r\n");
List fromItemsysItemvoucherPricesList401 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.voucherPricesList")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.voucherPricesList") instanceof List) fromItemsysItemvoucherPricesList401=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.voucherPricesList");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.voucherPricesList").getClass().isArray()) fromItemsysItemvoucherPricesList401=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"sysItem.voucherPricesList")).collect(Collectors.toList());
}
fromItemsysItemvoucherPricesList401.forEach(pay->{
try{
sb.append("	    			{id=");
sb.append(O2oUtil.getSmarty4jPropertyNil(pay,"id"));
sb.append(",unittype=");
...
sb.append("		package = { ");
sb.append("\r\n");
List fromItempackages354 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"packages")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"packages") instanceof List) fromItempackages354=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"packages");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"packages").getClass().isArray()) fromItempackages354=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"packages")).collect(Collectors.toList());
}
fromItempackages354.forEach(item->{
try{
sb.append("				\"");
...
sb.append(",  ");
sb.append("\r\n");
List fromItemresource852 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resource")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resource") instanceof List) fromItemresource852=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resource");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resource").getClass().isArray()) fromItemresource852=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resource")).collect(Collectors.toList());
}
fromItemresource852.forEach(res->{
try{
...
sb.append(", ");
sb.append("\r\n");
List fromItemresources537 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources") instanceof List) fromItemresources537=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources").getClass().isArray()) fromItemresources537=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources")).collect(Collectors.toList());
}
fromItemresources537.forEach(resource->{
try{
sb.append("					\"");
sb.append(resource);
sb.append("\",  ");
...
sb.append(", ");
sb.append("\r\n");
List fromItemresources404 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources") instanceof List) fromItemresources404=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources").getClass().isArray()) fromItemresources404=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources")).collect(Collectors.toList());
}
fromItemresources404.forEach(resource->{
try{
sb.append("					\"");
sb.append(resource);
sb.append("\",  ");
...
List fromItemresources914 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources")){
if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources") instanceof List) fromItemresources914=(List<?>)O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources");
else if (O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources").getClass().isArray()) fromItemresources914=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("fromItem"),"resources")).collect(Collectors.toList());
}
fromItemresources914.forEach(resource->{
try{
sb.append("					\"");
sb.append(resource);
sb.append("\",  ");
...
sb.append("				");
sb.append(O2oUtil.getSmarty4jPropertyNil(context.get("fromItem"),"gst_level"));
sb.append(",   ");
sb.append("\r\n");
}
sb.append("		gstExp= ");
...
sb.append("				");
sb.append(O2oUtil.getSmarty4jPropertyNil(context.get("fromItem"),"gst_level_exp"));
sb.append(",  ");
sb.append("\r\n");
}
}
...
sb.append("		characters={ ");
sb.append("\r\n");
List toItemsysItemcharacterList130 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.characterList")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.characterList") instanceof List) toItemsysItemcharacterList130=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.characterList");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.characterList").getClass().isArray()) toItemsysItemcharacterList130=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.characterList")).collect(Collectors.toList());
}
toItemsysItemcharacterList130.forEach(ids->{
try{
sb.append("				");
sb.append(ids);
sb.append(",  ");
...
sb.append("		gunproperty={ ");
sb.append("\r\n");
List toItemgunPropertypropertyList545 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.propertyList")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.propertyList") instanceof List) toItemgunPropertypropertyList545=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.propertyList");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.propertyList").getClass().isArray()) toItemgunPropertypropertyList545=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.propertyList")).collect(Collectors.toList());
}
toItemgunPropertypropertyList545.forEach(property->{
try{
sb.append("		{ ");
sb.append("\r\n");
...
sb.append("	combineDetail = { ");
sb.append("\r\n");
List toItemgunPropertystrPropertyList252 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.strPropertyList")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.strPropertyList") instanceof List) toItemgunPropertystrPropertyList252=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.strPropertyList");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.strPropertyList").getClass().isArray()) toItemgunPropertystrPropertyList252=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"gunProperty.strPropertyList")).collect(Collectors.toList());
}
toItemgunPropertystrPropertyList252.forEach(property->{
try{
sb.append("	    		{index= ");
sb.append(O2oUtil.getSmarty4jPropertyNil(property,"index"));
sb.append(", state=");
...
sb.append("	parts = { ");
sb.append("\r\n");
List toItemparts900 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"parts")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"parts") instanceof List) toItemparts900=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"parts");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"parts").getClass().isArray()) toItemparts900=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"parts")).collect(Collectors.toList());
}
toItemparts900.forEach(part->{
try{
sb.append("		{");
sb.append(O2oUtil.getSmarty4jPropertyNil(part,"sysItem.subType"));
sb.append(",\"");
...
sb.append("	gpprices={ ");
sb.append("\r\n");
List toItemsysItemgpPricesList746 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.gpPricesList")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.gpPricesList") instanceof List) toItemsysItemgpPricesList746=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.gpPricesList");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.gpPricesList").getClass().isArray()) toItemsysItemgpPricesList746=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.gpPricesList")).collect(Collectors.toList());
}
toItemsysItemgpPricesList746.forEach(pay->{
try{
sb.append("	    		{id=");
sb.append(O2oUtil.getSmarty4jPropertyNil(pay,"id"));
sb.append(",unittype=");
...
sb.append("	crprices={ ");
sb.append("\r\n");
List toItemsysItemcrPricesList373 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.crPricesList")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.crPricesList") instanceof List) toItemsysItemcrPricesList373=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.crPricesList");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.crPricesList").getClass().isArray()) toItemsysItemcrPricesList373=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.crPricesList")).collect(Collectors.toList());
}
toItemsysItemcrPricesList373.forEach(pay->{
try{
sb.append("	    		{id=");
sb.append(O2oUtil.getSmarty4jPropertyNil(pay,"id"));
sb.append(",unittype=");
...
sb.append("	voucherprices={ ");
sb.append("\r\n");
List toItemsysItemvoucherPricesList380 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.voucherPricesList")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.voucherPricesList") instanceof List) toItemsysItemvoucherPricesList380=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.voucherPricesList");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.voucherPricesList").getClass().isArray()) toItemsysItemvoucherPricesList380=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"sysItem.voucherPricesList")).collect(Collectors.toList());
}
toItemsysItemvoucherPricesList380.forEach(pay->{
try{
sb.append("	    		{id=");
sb.append(O2oUtil.getSmarty4jPropertyNil(pay,"id"));
sb.append(",unittype=");
...
sb.append("	package = { ");
sb.append("\r\n");
List toItempackages114 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"packages")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"packages") instanceof List) toItempackages114=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"packages");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"packages").getClass().isArray()) toItempackages114=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"packages")).collect(Collectors.toList());
}
toItempackages114.forEach(item->{
try{
sb.append("			\"");
sb.append(O2oUtil.getSmarty4jPropertyNil(item,"sysItem.displayName"));
sb.append("\",  ");
...
sb.append(",  ");
sb.append("\r\n");
List toItemresource176 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"resource")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resource") instanceof List) toItemresource176=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"resource");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resource").getClass().isArray()) toItemresource176=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"resource")).collect(Collectors.toList());
}
toItemresource176.forEach(res->{
try{
if((O2oUtil.compare(res,"!=",""))){
sb.append("					\"");
sb.append(res);
...
sb.append(", ");
sb.append("\r\n");
List toItemresources63 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources") instanceof List) toItemresources63=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources").getClass().isArray()) toItemresources63=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources")).collect(Collectors.toList());
}
toItemresources63.forEach(resource->{
try{
sb.append("				\"");
sb.append(resource);
sb.append("\",  ");
...
sb.append(", ");
sb.append("\r\n");
List toItemresources338 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources") instanceof List) toItemresources338=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources").getClass().isArray()) toItemresources338=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources")).collect(Collectors.toList());
}
toItemresources338.forEach(resource->{
try{
sb.append("				\"");
sb.append(resource);
sb.append("\",  ");
...
List toItemresources881 = new ArrayList<>();
if (null!=O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources")){
if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources") instanceof List) toItemresources881=(List<?>)O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources");
else if (O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources").getClass().isArray()) toItemresources881=Stream.of((Object[])O2oUtil.getSmarty4jProperty(context.get("toItem"),"resources")).collect(Collectors.toList());
}
toItemresources881.forEach(resource->{
try{
sb.append("				\"");
sb.append(resource);
sb.append("\",  ");
...
sb.append("			");
sb.append(O2oUtil.getSmarty4jPropertyNil(context.get("toItem"),"gst_level"));
sb.append(",   ");
sb.append("\r\n");
}
sb.append("	gstExp= ");
...
sb.append("			");
sb.append(O2oUtil.getSmarty4jPropertyNil(context.get("toItem"),"gst_level_exp"));
sb.append(",  ");
sb.append("\r\n");
}
}
