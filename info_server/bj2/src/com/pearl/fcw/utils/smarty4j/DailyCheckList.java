...
sb.append("\r\n");
List checkList732 = new ArrayList<>();
if (null!=context.get("checkList")){
if (context.get("checkList") instanceof List) checkList732=(List<?>)context.get("checkList");
else if (context.get("checkList").getClass().isArray()) checkList732=Stream.of((Object[])context.get("checkList")).collect(Collectors.toList());
}
checkList732.forEach(checkDay->{
try{
sb.append("		\"");
sb.append(checkDay);
sb.append("\", ");
