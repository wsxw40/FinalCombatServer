...
sb.append("\r\n");
List list713 = new ArrayList<>();
if (null!=context.get("list")){
if (context.get("list") instanceof List) list713=(List<?>)context.get("list");
else if (context.get("list").getClass().isArray()) list713=Stream.of((Object[])context.get("list")).collect(Collectors.toList());
}
list713.forEach(entry->{
try{
sb.append("		");
sb.append(entry);
sb.append(" ");
