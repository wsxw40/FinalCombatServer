...
sb.append("mission = { ");
sb.append("\r\n");
List list321 = new ArrayList<>();
if (null!=context.get("list")){
if (context.get("list") instanceof List) list321=(List<?>)context.get("list");
else if (context.get("list").getClass().isArray()) list321=Stream.of((Object[])context.get("list")).collect(Collectors.toList());
}
list321.forEach(amission->{
try{
sb.append("	{ ");
sb.append("\r\n");
sb.append("		");
...
sb.append(", ");
sb.append("\r\n");
Context includeContextVar3941=new Context();
includeContextVar3941.set("awardItemVos",O2oUtil.getSmarty4jProperty(amission,"awardItemVos"));
sb.append(new MissionItemAward().get(includeContextVar3941));
sb.append("  	}, ");
sb.append("\r\n");
}catch(Exception e2){
