...
public class CEditMap implements Ctx {
...
sb.append("configs = \"");
sb.append(O2oUtil.getSmarty4jPropertyNil(context.get("proto"),"configs"));
sb.append("\" ");
sb.append("\r\n");
sb.append("tsl = ");
sb.append(O2oUtil.getSmarty4jPropertyNil(context.get("proto"),"tsl"));
sb.append(" ");
sb.append("\r\n");
sb.append("name = \"");
