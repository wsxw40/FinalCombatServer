...
<ul class="sidebar-menu">
	...
	<li class="active"><a href="#/teams"><i class='fa fa-link'></i><span><fmt:message key="web.gm.menu.teams" /></span></a></li>
	<li class="hidden"><a href="#/team"><i class='fa fa-link'></i><span><fmt:message key="web.gm.menu.team" /></span></a></li>
	...
	<li class="treeview">
		...
		<ul class="treeview-menu">
			...
			<li><a href="#/sysItemPrices"><fmt:message key="web.gm.menu.sysItemPrices" /></a></li>
			<li class="hidden"><a href="#/sysItemPrice"><fmt:message key="web.gm.menu.sysItem" /></a></li>
			<li><a href="#/sysChests"><fmt:message key="web.gm.menu.sysChests" /></a></li>
			<li class="hidden"><a href="#/sysChest"><fmt:message key="web.gm.menu.sysChest" /></a></li>
			<li><a href="#/sysStrengthenAppends"><fmt:message key="web.gm.menu.sysStrengthenAppends" /></a></li>
			<li class="hidden"><a href="#/sysStrengthenAppend"><fmt:message key="web.gm.menu.sysStrengthenAppend" /></a></li>
	  </ul>
	</li>
	<li class="treeview">
		...
		<ul class="treeview-menu">
			...
			<li><a href="#/sysNotices"><fmt:message key="web.gm.menu.sysNotices" /></a></li>
			<li class="hidden"><a href="#/sysNotice"><fmt:message key="web.gm.menu.sysNotice" /></a></li>
	  </ul>
	</li>
	<li class="treeview">
