...
function initSysItemsController($scope){
	...
	var table=initTable('#tableSysItems',
			...
			[{data:'id'},
			 ...
			 {data:'modifiedDesc'},
			 {data:'shoppingType'},
			 {data:'shoppingStartTime'},
			 {data:'shoppingEndTime'},
			 {data:'cId'},
			 {data:'iId'},
			 {data:'iValue'},
			 {data:'characterId'},
			...
			{add:$('#app_root').val()+'/fcw/#/sysItem',
				...
				//restore:$('#app_root').val()+'/fcw/gm/restoreSysItem',
...
<!-- 		<button type="button" id="restore" class="btn btn-info" > -->
<%-- 			<i class="fa fa-refresh"></i>&nbsp;<fmt:message key="web.gm.button.restore"/> --%>
<!-- 		</button> -->
...
<th property="shoppingType" title="<fmt:message key="web.gm.sysItems.col.shoppingType.toolTips" />">
	<fmt:message key="web.gm.sysItems.col.shoppingType.title" />
</th>
<th property="shoppingStartTime" title="<fmt:message key="web.gm.sysItems.col.shoppingStartTime.toolTips" />">
	<fmt:message key="web.gm.sysItems.col.shoppingStartTime.title" />
</th>
<th property="shoppingEndTime" title="<fmt:message key="web.gm.sysItems.col.shoppingEndTime.toolTips" />">
	<fmt:message key="web.gm.sysItems.col.shoppingEndTime.title" />
</th>
