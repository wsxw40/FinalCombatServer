	...
	initTable('#tableMessages',
			...
			[{data:'id'},
			 ...
			 {data:function(data, type, full, meta){
				 var msg=data.senderName.replace(/</img,'&lt;').replace(/>/img,'&gt;');
				 return '<span class="large-width" title="'+data.senderName+'">'+msg+'</span>';
			 }},
			 {data:'receiverId'},
			 {data:'isDeleted'},
			 {data:function(data, type, full, meta){
				 var msg=data.subject.replace(/</img,'&lt;').replace(/>/img,'&gt;');
				 return '<span class="large-width" title="'+data.subject+'">'+msg+'</span>';
			 }},
			 {data:function(data, type, full, meta){
				 var msg=data.content.replace(/</img,'&lt;').replace(/>/img,'&gt;');
				 return '<span class="large-width" title="'+data.content+'">'+msg+'</span>';
			 }},
			 {data:'createdTime'},
			 {data:'open'},
			 {data:'isAttached'},
