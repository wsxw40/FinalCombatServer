...
<div class="form-group">
	...
	<label for="index" class="col-sm-2 control-label"><fmt:message key="web.gm.servers.col.picture.title"/></label>
	<div class="col-sm-4" title="<fmt:message key="web.gm.servers.col.picture.toolTips"/>">
		<input class="form-control" id="index" ng-model="picture"  name="picture"placeholder="<fmt:message key="web.gm.servers.col.picture.toolTips"/>" />
	</div>
</div>
<div class="form-group">
