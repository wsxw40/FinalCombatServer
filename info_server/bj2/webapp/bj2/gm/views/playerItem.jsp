...
<div class="box box-primary">
    ...
    <div class="box-body">
		<form id="formPlayerItem" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/fcw/gm/savePlayerItem">
			...
			<div class="form-group">
				<label for="level" class="col-sm-2 control-label"><fmt:message key="web.gm.playerItems.col.durable.title"/></label>
				<div class="col-sm-4" title="<fmt:message key="web.gm.playerItems.col.durable.toolTips"/>">
					<input type="number" class="form-control" id="durable" ng-model="durable"  name="durable"
					placeholder="<fmt:message key="web.gm.playerItems.col.durable.toolTips"/>" />
				</div>
			</div>
			<div class="form-group">
