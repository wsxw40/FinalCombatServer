 ...
 */
public class CMDecoder extends OneToOneDecoder {
	...
	protected Object decode(ChannelHandlerContext ctx, Channel channel, Object msg) throws Exception {
		if (msg instanceof ChannelBuffer) {
			...
			if (headtip == PJMessage.HEADTIP) {
				...
				System.err.println("CMDecoder Message HEADTIP Error ! headtip:" + headtip);
				channel.close();
				return null;
			}
		} else {
			System.err.println("CMDecoder Message Type Error :" + msg);
			return msg;
		}
	}
