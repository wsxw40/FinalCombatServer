					...
					for (PlayerItem playerItem : itemArray) {
						...
						if(playerItem.getProvisional_item_flag()){
							...
							if(flag == null || "".equals(flag)){//没值
								nosqlService.getNosql().set(key, "30");
								playerItem.setProvisional_item_day(30);//默认可以续费天数为30天
								//System.out.println("getPlayerItemList:91 "+30);
							}else {
								playerItem.setProvisional_item_day(Integer.valueOf(flag));
								//System.out.println("getPlayerItemList:94 "+Integer.valueOf(flag));
							}
						}
					}
					//zlm2015-5-7-限时装备-结束-------------------------------------
