...
public class GetExchangeSysItemList extends BaseClientServlet {
	...
	protected String innerService(String... args) {
		...
		try{
			...
			int reviceCoinNum= ServiceLocator.getService.getPlayerItemsTotalQuantityByIid(playerId, Constants.DEFAULT_ITEM_TYPE, Constants.SPECIAL_ITEM_IIDS.RELIVE_COIN.getValue());
			...
			return Converter.exchangeSysItemList(page, pages, list, player.getRank(),chipNum,reviceCoinNum);
		}catch(Exception e){
