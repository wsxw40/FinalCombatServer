...
public class ConfigurationUtil {
	...
	public static final List<String> GM_USER_IDS		=	GM_USER_IDS_FLAG!=null&&GM_USER_IDS_FLAG.length()>0?StringUtil.toList(GM_USER_IDS_FLAG.replace(Constants.XUNLEI_LOG_DELIMITER, Constants.DELIMITER_RESOURCE_STABLE)):null;				
