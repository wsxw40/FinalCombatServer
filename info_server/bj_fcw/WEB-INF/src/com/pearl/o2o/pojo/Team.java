...
//		}
	...
	private void caculateTeamRes(){
		...
		if(orgDurSeconds>=Constants.TeamSpaceConstants.TEAM_ORG_RES_PRODUCT_INTERVAL){
			increaseOrgNum=(orgDurSeconds)/Constants.TeamSpaceConstants.TEAM_ORG_RES_PRODUCT_INTERVAL
		...
		if(conDurSeconds>=Constants.TeamSpaceConstants.TEAM_ORG_RES_CONVERT_INTERVAL){
			...
			increaseGiftNum=(conDurSeconds)/Constants.TeamSpaceConstants.TEAM_ORG_RES_CONVERT_INTERVAL
					*(teamSLC.gettGiftRes());
