...
public interface SingleSourceRouter {
    ...
    <T extends BaseEntity> T queryById(Integer id, Class<T> clazz);

    <T extends BaseEntity> List<T> queryByIds(Collection<Integer> ids, Class<T> clazz);

    <T extends BaseEntity> Map<Integer, T> queryByIdsForMap(Collection<Integer> ids, Class<T> clazz);
    ...
    <T extends BaseEntity> int getMaxID(Class<T> clazz);

    <T extends BaseEntity> List<Integer> queryIdsByFK(long fk, Class<T> clazz, String fieldName);

    <T extends BaseEntity> List<Integer> queryAllIds(Class<T> clazz);
    ...
    List<Integer> queryForLongList(String sql, Object... parameters);
