...
public abstract class ClassMetadataWrapper<T extends BaseEntity> {
    ...
    public String getQueryByIds(Collection<Integer> ids) {
    ...
    public String getQueryByIds(String tableSuffix, Collection<Integer> ids) {
        StringBuilder sb = new StringBuilder();
    ...
    protected static final <T extends BaseEntity> ClassMetadataWrapper<T> getInstance(ClassMetadata cm) {
        ...
        try {
            ...
            cc = pool.makeClass(ClassMetadataWrapper.class.getPackage() + "." + "Wrapper_" + cm.getJavaClass().getSimpleName(), icc);
            ...
            throw new RuntimeException("JavaClass:"+cm.getJavaClass().getName()+",Name:"+(cc!=null?cc.getSimpleName():null)+" \r\n" + e);
        }
    }
