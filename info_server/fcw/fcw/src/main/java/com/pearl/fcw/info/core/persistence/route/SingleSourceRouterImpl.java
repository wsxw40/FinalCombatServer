...
public class SingleSourceRouterImpl extends AbstractSourceRouter implements
		SingleSourceRouter {
	...
	public <T extends BaseEntity> T queryById(Integer id, Class<T> clazz) {
		...
		return super.queryForObject(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(), wrapper.getQueryByIdSql(),
				id);
	}
	...
	public <T extends BaseEntity> List<T> queryByIds(Collection<Integer> ids,
		...
		return super.query(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(), sql);
	}
	...
	public <T extends BaseEntity> List<T> queryByFK(long fk, Class<T> clazz,
		...
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.query(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(),
				wrapper.getQueryByFK(fieldName), fk);
	}
	...
	public <T extends BaseEntity> List<T> queryAll(Class<T> clazz) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.query(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(), wrapper.getQueryAllSql());
	}
	...
	public <T extends BaseEntity> List<T> query(Class<T> clazz, String sql,
		...
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.query(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(), sql, parameters);
	}
	...
	public <T extends BaseEntity> List<T> query(Class<T> clazz,
		...
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.query(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(), namedSql, namedParameters);
	}
	...
	public <T extends BaseEntity> List<T> query(Class<T> clazz, String sql,
		...
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.query(namedParameterJdbcTemplate,
				wrapper.getParameterizedRowMapper(), sql, entity);
	}

	@Override
	public List<Map<String, Object>> query(String sql, Object... parameters) {
		return namedParameterJdbcTemplate.getJdbcOperations().queryForList(sql,
				parameters);
	}
	...
	public <T extends BaseEntity> int getMaxID(Class<T> clazz) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.queryForLong(namedParameterJdbcTemplate,
				wrapper.getQueryMaxId());
	}
	...
	public <T extends BaseEntity> List<Integer> queryIdsByFK(long fk,
		...
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.queryForLongList(namedParameterJdbcTemplate,
				wrapper.getQueryByFK(fieldName), fk);
	}
	...
	public <T extends BaseEntity> List<Integer> queryAllIds(Class<T> clazz) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
		return super.queryForLongList(namedParameterJdbcTemplate,
				wrapper.getQueryAllIdsSql());
	}

	@Override
	public <T extends BaseEntity> int insert(T entity) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(entity.getClass());
		return super.insert(namedParameterJdbcTemplate,
				wrapper.getInsertPreparedStatementCreator(entity), wrapper
						.getClassMetadata().getPrimaryKey().isAutoIncreaseId(),
				entity);
	}
	...
	public <T extends BaseEntity> int insertNoIncrement(T entity) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(entity.getClass());
		return super.insertNoIncrement(namedParameterJdbcTemplate,
				wrapper.getInsertNoIncrementPreparedStatementCreator(entity));
	}
	...
	public <T extends BaseEntity> int update(T entity) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(entity.getClass());
		return super.update(namedParameterJdbcTemplate,
				wrapper.getNamedParameterUpdateSql(), entity);
	}
	...
	public <T extends BaseEntity> int delete(T entity) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(entity.getClass());
		return super.update(namedParameterJdbcTemplate,
				wrapper.getNamedParameterDeleteSql(), entity);
	}
	...
	public <T extends BaseEntity> int hardDelete(T entity) {
		ClassMetadataWrapper<T> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(entity.getClass());
		return super.update(namedParameterJdbcTemplate,
				wrapper.getHardDeleteSql(), entity.getId());
	}
	...
	public List<Integer> queryForLongList(String sql, Object... parameters) {
		return super.queryForLongList(namedParameterJdbcTemplate, sql,
				parameters);
	}
	...
	public <Y> Y queryForObject(String sql, Class<Y> requiredType,
			Object... parameters) {
		return super.queryForObject(namedParameterJdbcTemplate, sql,
				requiredType, parameters);
	}
	...
	public void batchUpdate(Collection<BaseEntity> entities) {
		...
		for (Map.Entry<Class<?>, List<BaseEntity>> entry : map.entrySet()) {
			try {
				...
				ClassMetadataWrapper<BaseEntity> wrapper = ClassMetadataConfig
						.getClassMetadataWrapper(entry.getKey());
				SqlParameterSource[] batch = SqlParameterSourceUtils
						.createBatch(entry.getValue().toArray());
				namedParameterJdbcTemplate.batchUpdate(
						wrapper.getNamedParameterUpdateSql(), batch);
			} catch (Exception e) {
...
//		final Date now = DateUtil.now();
		...
		final ClassMetadataWrapper<BaseEntity> wrapper = ClassMetadataConfig
				.getClassMetadataWrapper(clazz);
...
//				e.setCreateTime(now.getTime());
		...
		namedParameterJdbcTemplate.getJdbcOperations().batchUpdate(
				wrapper.getInsertSql(), setter);
	}

	@Override
	public <T extends BaseEntity> void batchInsertNoIncrement(
...
//				e.setCreateTime(now.getTime());
		...
		namedParameterJdbcTemplate.getJdbcOperations().batchUpdate(
				wrapper.getInsertSqlNoIncrement(), setter);
	}
