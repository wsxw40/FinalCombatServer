...
//@Entity
//@Schema(GoSchema.SYS)
public class SysLevel implements Comparable<SysLevel>{//extends BasePojo  {
	...
	private int num4Team;
	private int isGm;

	public int getNum4Team() {
		return num4Team;
	}

	public void setNum4Team(int num4Team) {
		this.num4Team = num4Team;
	}
	...
	@Override
	public int compareTo(SysLevel o) {
