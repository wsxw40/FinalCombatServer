...
public class TeamLevelModeInfo extends LevelModeInfo {
	...
	public static class ConfigPoint {
		...
		public String toPlainString() {
			...
			sb.append(itemId).append(",").append(transform.toPlainString())
					.append(",").append(point.toPlainString());
			return sb.toString();
		}
		...
		public static ConfigPoint createFromText(String s) {
			...
			String transStr = sArray[1] + "," + sArray[2] + "," + sArray[3]
					+ "," + sArray[4];
			String pointStr = sArray[5] + "," + sArray[6] + "," + sArray[7];
			return new ConfigPoint(Integer.valueOf(itemId),
					Transform.createFromText(transStr),
