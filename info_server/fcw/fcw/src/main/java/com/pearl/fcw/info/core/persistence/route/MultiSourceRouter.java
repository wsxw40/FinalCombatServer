...
public interface MultiSourceRouter {
    ...
    <T extends BaseShardingEntity> T queryById(long shardingKey, Integer id, Class<T> clazz);

    <T extends BaseShardingEntity> List<T> queryByIds(long shardingKey, Collection<Integer> ids, Class<T> clazz);

    <T extends BaseShardingEntity> Map<Integer, T> queryByIdsForMap(long shardingKey, Collection<Integer> ids, Class<T> clazz);
    ...
    <T extends BaseShardingEntity> List<Integer> queryIdsByFK(long shardingKey, long fk, Class<T> clazz, String fieldName);

    <T extends BaseShardingEntity> List<Integer> queryAllIds(Class<T> clazz);
