...
public abstract class AbstractSourceRouter {
    ...
    protected static final RowMapper<Integer> longRowMapper = new RowMapper<Integer>() {
        @Override
    ...
    protected List<Integer> queryForLongList(NamedParameterJdbcTemplate namedParameterJdbcTemplate, String sql, Object... parameters) {
        return namedParameterJdbcTemplate.getJdbcOperations().query(sql, longRowMapper, parameters);
    }

    protected List<Integer> queryForLongList(NamedParameterJdbcTemplate namedParameterJdbcTemplate, String namedSql, Map<String, Object> namedParameters) {
    ...
    protected int queryForLong(NamedParameterJdbcTemplate namedParameterJdbcTemplate, String sql, Object... parameters) {
    ...
    protected static <T extends BaseEntity> Map<Integer, T> toPKMap(Collection<Integer> ids, Collection<T> entities, Class<T> clazz) {

        Map<Integer, T> result = EntityUtils.toPKMap(entities);
