...
public class MultiGenericDao<T extends BaseShardingEntity> extends AbstractGenericDao<T> {
    ...
    public T get(long shardingKey, Integer id) {
    ...
    public Map<Integer, T> getByIds(long shardingKey, Collection<Integer> ids) {
        return multiSourceRouter.queryByIdsForMap(shardingKey, ids, clazz);
    }

    public List<T> getByIdsList(long shardingKey, Collection<Integer> ids) {
        return multiSourceRouter.queryByIds(shardingKey, ids, clazz);
    }

    public Map<Integer, T> getByFK(long shardingKey, long fk, Class<?> foreignClass) {
    ...
    public Map<Integer, T> getByFK(long shardingKey, long fk, Class<?> foreignClass, String fieldName) {
