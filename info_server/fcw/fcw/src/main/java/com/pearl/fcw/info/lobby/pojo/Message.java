...
public class Message extends BasePojo{
	...
	public void init() {
		if (this.createdTime != null) {
			...
			this.createdTimeStr = new SimpleDateFormat("yyyy-MM-dd HH:mm")
					.format(this.createdTime);
			this.createdDateStr = new SimpleDateFormat("yyyy-MM-dd")
					.format(this.createdTime);
		}
	}
	...
	@Transient private List<SysItem> itemList;
	private Integer messageModeId;
	private Integer playerItemId;

	@Transient private PlayerItem playerItem;
