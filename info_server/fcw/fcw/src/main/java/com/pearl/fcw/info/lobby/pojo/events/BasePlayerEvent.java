...
import com.pearl.fcw.info.core.persistence.utils.Converter;
...
public class BasePlayerEvent extends PlayerNosqlRecord {
	...
	public BasePlayerEvent(String content, String time, int playerId,
			String playerName) {
	...
	public BasePlayerEvent(int playerId, String playerName, String time,
			String nosqlPlainStr) {
		super(playerId, playerName);
		this.time = time;
		this.content = "";
	...
	public String generateNosqlPlainStr() {
		return "" + time.toString() + DELEMETER
				+ Converter.friendNewsEntry(this);
	}

	public static BasePlayerEvent getFromNosqlPlainStr(String str,
