...
public class Bootstrap {
    ...
    private static final String RUNTIME_VERSION_NAME = "fcw.runtime.version";
    ...
    public static com.pearl.fcw.info.core.network.Server fcwServer = null;
    ...
    private void stop() throws Exception {
        if (running) {
            ...
            try {
                ...
                logger.error("Stop fcw server: ", e);
            }
