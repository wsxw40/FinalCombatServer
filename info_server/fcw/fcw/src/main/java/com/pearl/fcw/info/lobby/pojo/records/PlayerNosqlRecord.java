package com.pearl.fcw.info.lobby.pojo.records;
...
public abstract class PlayerNosqlRecord extends NosqlRecord {
	...
	public PlayerNosqlRecord(int playerId, String playerName) {
	...
	public static String getKey(int playerId, String playerName,
			NoSqlDataType nosqlDataType, String recordType) {
		return new StringBuilder().append(PREFIX).append(playerId).append(":")
