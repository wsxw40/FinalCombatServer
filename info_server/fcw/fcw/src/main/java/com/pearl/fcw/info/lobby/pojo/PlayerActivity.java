...
@Entity
@Schema(GoSchema.EXT)
public class PlayerActivity implements BaseShardingEntity {
	...
	@Transient private SysActivity sysActivity;
	...
	public PlayerActivity(SysActivity sysActivity, int playerId) {
		Object[] o2 = {
				CommonUtil.dateFormat.format(sysActivity.getStartTime()),
				CommonUtil.dateFormat.format(sysActivity.getEndTime()) };
		...
		this.status = 0;
		this.number = 0;
		if (sysActivity.getAction() == 5 || sysActivity.getAction() == 6
				|| sysActivity.getAction() == 7
				|| sysActivity.getAction() == 10
				|| sysActivity.getAction() == 18
				|| sysActivity.getAction() == 19
				|| sysActivity.getAction() == 20
				|| sysActivity.getAction() == 24) {
