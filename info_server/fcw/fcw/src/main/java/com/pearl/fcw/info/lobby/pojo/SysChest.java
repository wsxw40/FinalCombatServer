...
public class SysChest {//extends BasePojo implements Comparable<SysChest> {

	private static final long serialVersionUID = -2471157768356744004L;

	private int type;// 1:default item 2:random item where type=1, it's a
						// sysChest
	...
	private int number;
	private int useType;// 0:永久 1:个数 2:时间
