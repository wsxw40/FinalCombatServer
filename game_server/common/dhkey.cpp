...
bool CDHKey::Agree(unsigned char *EncryptionKey,unsigned char *RecipientInterKey)
{
	...
	key.vtobuf(EncryptionKey,size);
	{
		...
		n.vtobuf(nbuf, size);
		key.vtobuf(tmp, size);
		log_write(LOG_DEBUG1, "Agree n=%02x%02x%02x%02x%02x%02x%02x%02x aInter=%02x%02x%02x%02x%02x%02x%02x%02x shared=%02x%02x%02x%02x%02x%02x%02x%02x",
			nbuf[0],nbuf[1],nbuf[2],nbuf[3],nbuf[4],nbuf[5],nbuf[6],nbuf[7],
			RecipientInterKey[0],RecipientInterKey[1],RecipientInterKey[2],RecipientInterKey[3],
			RecipientInterKey[4],RecipientInterKey[5],RecipientInterKey[6],RecipientInterKey[7],
